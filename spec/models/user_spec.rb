...
describe User do
  ...
  describe "password encryption" do
    ...
    describe "authenticate method" do
      ...
      it "should return nil if user with that e-mail address is not found" do
        nonexistant_user = User.authenticate("noonewouldbetupidenoughtoh@vethisemailaddress.com", @valid_attributes[:password])
        nonexistant_user.should be_nil
      end
      it "should return the user if all details check out correct" do
